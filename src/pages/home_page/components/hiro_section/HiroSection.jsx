...
const HiroSection = () => {
  return (
    <div>
      <section className="">
        <div className="grid max-w-screen-xl gap-12 px-6  py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className=" place-self-center lg:col-span-7 text-center lg:text-start">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              ...
              offline. Using the Zero Knowledge Proof (ZKP) technology and the
              power of Starknet, SoloSafe ensures that your transactions are
              secure over the internet or bluetooth.
            </p>
            <a
              href="#"
