      ...
      <nav className=" fixed w-full z-50 top-0 bg-white shadow-sm ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div
            ...
            id="navbar-sticky"
          >
            <ul className="flex w-full justify-between  gap-2 p-4 md:p-0 mt-6 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row  md:mt-0 md:border-0   dark:border-gray-700">
              <li>
